...
export function Footer() {
  ...
  return (
    <footer>
      <div className="flex justify-center gap-8 opacity-50 text-sm">
        <NextLink
          href="https://beian.mps.gov.cn/#/query/webSearch?code=12010402002133"
          target="_blank">
          津公网安备12010402002133
        </NextLink>
        <NextLink href="https://beian.miit.gov.cn/" target="_blank">
          津ICP备2024023298号-1
        </NextLink>
      </div>
    </footer>
